...
export const metadata: Metadata = {
  title: "Gon-No-Gordon - Authentic Japanese Sushi Restaurant",
  description: "Experience the finest traditional sushi at Gon-No-Gordon. Premium ingredients, master chefs, and authentic Japanese cuisine in an elegant setting.",
  keywords: ["sushi restaurant", "Japanese cuisine", "authentic sushi", "omakase", "fresh fish", "sashimi", "premium dining"],
  metadataBase: new URL("https://gon-no-gordon.com"),
  alternates: {
    canonical: "https://gon-no-gordon.com"
  },
  openGraph: {
    title: "Gon-No-Gordon - Authentic Japanese Sushi Restaurant",
    description: "Experience the finest traditional sushi with premium ingredients and master chefs",
    siteName: "Gon-No-Gordon",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763713462244-gk79gzpx.jpg",
        alt: "Master sushi chef at Gon-No-Gordon"
      }
    ]
  },
  twitter: {
    ...
    title: "Gon-No-Gordon - Authentic Japanese Sushi Restaurant",
    description: "Experience the finest traditional sushi with premium ingredients and master chefs",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763713462244-gk79gzpx.jpg"]
  },
  robots: {
    index: true,
    follow: true
